...
The following [collaborationists](https://en.wikipedia.org/wiki/Collaborationism) and their criminal associates participated in different ways. Some gave their full heart to the cause, others tried to exact their sentences in a suave and effortless fashion, and others attempted to maximize impact attemptinbg to be as poisonous as they could, resorting to controllinng my tongue with phrases combining corruption of words like "Police", "Portugal", "Catholic" and "Netherlands" revealing their true psychotic nature ;)
